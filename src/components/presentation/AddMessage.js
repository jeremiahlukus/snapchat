...
class AddMessage extends Component {
  ...
  render() {
    const buttonType = this.state.showInputs
      ? config.images.send
      : config.images.plus;
    ...
    return (
      <View>
        ...
        <TouchableOpacity
          ...
          style={styles.circle}
        >
          <Image style={{ width: 40, height: 40 }} source={buttonType} />
        </TouchableOpacity>
      </View>
    );
  }
